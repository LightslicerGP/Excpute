...
print('\n', split_instructions)
print('\n', binary_instruction)
print('\n', len(binary_instruction), 'bits,', int(len(binary_instruction)/8),
      'bytes,', int(len(binary_instruction)/16), 'instructions')

with open('binary instruction', 'w') as output_file:
    output_file.write(binary_instruction)

print(f"Binary instruction written to binary instruction.txt")
